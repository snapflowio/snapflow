...
pub async fn oauth_authorize(
    ...
    authorize_request: models::AuthorizeRequest,
    x_snapflow_organization_id: Option<&str>,
) -> Result<models::AuthorizeResponse, Error<OauthAuthorizeError>> {
...
pub async fn oauth_exchange_token(
    ...
    x_snapflow_organization_id: Option<&str>,
) -> Result<models::TokenResponse, Error<OauthExchangeTokenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
