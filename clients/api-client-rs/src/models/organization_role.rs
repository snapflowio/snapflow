...
impl OrganizationRole {
    pub fn new(created_at: String, description: String, id: uuid::Uuid, is_global: bool, name: String, permissions: Vec<Permissions>, updated_at: String) -> OrganizationRole {
        OrganizationRole {
            created_at,
            description,
            id,
