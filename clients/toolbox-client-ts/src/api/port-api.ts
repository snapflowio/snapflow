	...
	return {
		...
		> {
			...
			const localVarOperationServerBasePath =
				operationServerMap['PortApi.isPortInUse']?.[
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.listPorts(options);
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
			const localVarOperationServerBasePath =
				operationServerMap['PortApi.listPorts']?.[localVarOperationServerIndex]
					?.url;
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
...
export const PortApiFactory = (
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		listPorts(options?: RawAxiosRequestConfig): AxiosPromise<PortList> {
			return localVarFp
				.listPorts(options)
				.then((request) => request(axios, basePath));
		},
...
export class PortApi extends BaseAPI {
	 ...
	 * @memberof PortApi
	 */
	public isPortInUse(port: string, options?: RawAxiosRequestConfig) {
	 ...
	 * @memberof PortApi
	 */
	public listPorts(options?: RawAxiosRequestConfig) {
		return PortApiFp(this.configuration)
			.listPorts(options)
			.then((request) => request(this.axios, this.basePath));
	}
