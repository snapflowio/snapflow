...
export const ImagesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    toggleImageState: async (
      ...
      const localVarPath = `/images/{id}/toggle`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    async activateImage(
      ...
      const localVarOperationServerBasePath =
        operationServerMap["ImagesApi.activateImage"]?.[localVarOperationServerIndex]?.url;
    ...
    async removeImage(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.removeImage(
        id,
        xSnapflowOrganizationID,
        options
      );
...
export const ImagesApiFactory = function (
  ...
  return {
    ...
    getAllImages(
      ...
      return localVarFp
        .getAllImages(xSnapflowOrganizationID, limit, page, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    removeImage(
      ...
      return localVarFp
        .removeImage(id, xSnapflowOrganizationID, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    setImageGeneralStatus(
      ...
      return localVarFp
        .setImageGeneralStatus(id, setImageGeneralStatusDto, xSnapflowOrganizationID, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    toggleImageState(
      ...
      return localVarFp
        .toggleImageState(id, toggleState, xSnapflowOrganizationID, options)
        .then((request) => request(axios, basePath));
    },
  };
};
