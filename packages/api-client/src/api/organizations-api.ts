...
export const OrganizationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateAssignedOrganizationRoles: async (organizationId: string, userId: string, updateAssignedOrganizationRoles: UpdateAssignedOrganizationRoles, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organizationId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateRoleForOrganizationMember: async (organizationId: string, userId: string, updateOrganizationMemberRole: UpdateOrganizationMemberRole, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'organizationId' is not null or undefined
...
export const OrganizationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getOrganizationUsageOverview(organizationId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UsageOverview>> {
         ...
         * @throws {RequiredError}
         */
        async updateAssignedOrganizationRoles(organizationId: string, userId: string, updateAssignedOrganizationRoles: UpdateAssignedOrganizationRoles, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationUser>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OrganizationsApi.updateAssignedOrganizationRoles']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async updateRoleForOrganizationMember(organizationId: string, userId: string, updateOrganizationMemberRole: UpdateOrganizationMemberRole, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationUser>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OrganizationsApi.updateRoleForOrganizationMember']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class OrganizationsApi extends BaseAPI {
     ...
     * @memberof OrganizationsApi
     */
    public updateAssignedOrganizationRoles(organizationId: string, userId: string, updateAssignedOrganizationRoles: UpdateAssignedOrganizationRoles, options?: RawAxiosRequestConfig) {
     ...
     * @memberof OrganizationsApi
     */
    public updateRoleForOrganizationMember(organizationId: string, userId: string, updateOrganizationMemberRole: UpdateOrganizationMemberRole, options?: RawAxiosRequestConfig) {
