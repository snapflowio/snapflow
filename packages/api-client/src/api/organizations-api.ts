...
// @ts-ignore
import type { CreateOrganizationCheckout } from "../models";
// @ts-ignore
...
export const OrganizationsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {CreateOrganizationCheckout} createOrganizationCheckout
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    createCheckoutLink: async (
      organizationId: string,
      createOrganizationCheckout: CreateOrganizationCheckout,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'organizationId' is not null or undefined
      assertParamExists("createCheckoutLink", "organizationId", organizationId);
      // verify required parameter 'createOrganizationCheckout' is not null or undefined
      assertParamExists(
        "createCheckoutLink",
        "createOrganizationCheckout",
        createOrganizationCheckout
      );
      const localVarPath = `/organizations/{organizationId}/billing/checkout`.replace(
        `{${"organizationId"}}`,
...
export const OrganizationsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async acceptOrganizationInvitation(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.acceptOrganizationInvitation(
        invitationId,
        options
      );
    ...
    async createCheckoutLink(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.createCheckoutLink(
        organizationId,
        createOrganizationCheckout,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationsApi.createCheckoutLink"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async declineOrganizationInvitation(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.declineOrganizationInvitation(
        invitationId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    async getOrganizationUsageOverview(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.getOrganizationUsageOverview(
        organizationId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    async leaveOrganization(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.leaveOrganization(
        organizationId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationsApi.leaveOrganization"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async listOrganizationInvitations(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrganizationInvitation>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listOrganizationInvitations(
        organizationId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listOrganizationInvitationsForAuthenticatedUser(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
    ...
    async listOrganizationMembers(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrganizationUser>>
    > {
    ...
    async listOrganizationRoles(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrganizationRole>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listOrganizationRoles(
        organizationId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationsApi.listOrganizationRoles"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async suspendOrganization(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationsApi.suspendOrganization"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async unsuspendOrganization(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.unsuspendOrganization(
        organizationId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationsApi.unsuspendOrganization"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async updateAssignedOrganizationRoles(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationsApi.updateAssignedOrganizationRoles"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async updateRoleForOrganizationMember(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["OrganizationsApi.updateRoleForOrganizationMember"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const OrganizationsApiFactory = function (
  ...
  return {
    ...
    cancelOrganizationInvitation(
      ...
      return localVarFp
        .cancelOrganizationInvitation(invitationId, organizationId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    createCheckoutLink(
      ...
      return localVarFp
        .createCheckoutLink(organizationId, createOrganizationCheckout, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
