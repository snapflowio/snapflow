...
export const SandboxApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async setAutoArchiveInterval(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["SandboxApi.setAutoArchiveInterval"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
...
export const SandboxApiFactory = function (
  ...
  return {
    ...
    getSandbox(
      ...
      return localVarFp
        .getSandbox(sandboxId, xSnapflowOrganizationID, verbose, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    listSandboxes(
      ...
      return localVarFp
        .listSandboxes(xSnapflowOrganizationID, verbose, labels, includeErroredDeleted, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    replaceLabels(
      ...
      return localVarFp
        .replaceLabels(sandboxId, sandboxLabels, xSnapflowOrganizationID, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    setAutoArchiveInterval(
      ...
      return localVarFp
        .setAutoArchiveInterval(sandboxId, interval, xSnapflowOrganizationID, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    setAutostopInterval(
      ...
      return localVarFp
        .setAutostopInterval(sandboxId, interval, xSnapflowOrganizationID, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
