...
export const RunnersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getRunnersBySnapshotInternalName: async (internalName: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const RunnersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRunnersBySnapshotInternalName(internalName: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RunnerSnapshotDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRunnersBySnapshotInternalName(internalName, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['RunnersApi.getRunnersBySnapshotInternalName']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const RunnersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getRunnersBySnapshotInternalName(internalName: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<RunnerSnapshotDto>> {
            return localVarFp.getRunnersBySnapshotInternalName(internalName, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary List all runners
...
export class RunnersApi extends BaseAPI {
    ...
    public getRunnersBySnapshotInternalName(internalName: string, options?: RawAxiosRequestConfig) {
        return RunnersApiFp(this.configuration).getRunnersBySnapshotInternalName(internalName, options).then((request) => request(this.axios, this.basePath));
    }
