  ...
  return {
    ...
    async createRegistry(
      ...
      const localVarOperationServerBasePath =
        operationServerMap["RegistryApi.createRegistry"]?.[localVarOperationServerIndex]?.url;
    ...
    async deleteRegistry(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["RegistryApi.deleteRegistry"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getRegistry(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["RegistryApi.getRegistry"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async getTransientPushAccess(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["RegistryApi.getTransientPushAccess"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async listRegistries(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["RegistryApi.listRegistries"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async setDefaultRegistry(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.setDefaultRegistry(
        id,
        xSnapflowOrganizationID,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["RegistryApi.setDefaultRegistry"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async updateRegistry(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["RegistryApi.updateRegistry"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const RegistryApiFactory = function (
  ...
  return {
    ...
    createRegistry(
      ...
      return localVarFp
        .createRegistry(createDockerRegistry, xSnapflowOrganizationID, options)
    ...
    updateRegistry(
      ...
      return localVarFp
        .updateRegistry(id, updateDockerRegistry, xSnapflowOrganizationID, options)
        .then((request) => request(axios, basePath));
    },
  };
};
