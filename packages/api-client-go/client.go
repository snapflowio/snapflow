...
// APIClient manages communication with the Snapflow API v1.0
...
type APIClient struct {
	...
	StreamableHttpAPI StreamableHttpAPI
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.StreamableHttpAPI = (*StreamableHttpAPIService)(&c.common)
