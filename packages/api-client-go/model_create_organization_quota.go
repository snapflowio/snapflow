...
// GetBucketQuota returns the BucketQuota field value if set, zero value otherwise.
func (o *CreateOrganizationQuota) GetBucketQuota() float32 {
	if o == nil || IsNil(o.BucketQuota) {
		var ret float32
		return ret
	}
	return *o.BucketQuota
}

// GetBucketQuotaOk returns a tuple with the BucketQuota field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateOrganizationQuota) GetBucketQuotaOk() (*float32, bool) {
	if o == nil || IsNil(o.BucketQuota) {
		return nil, false
	}
	return o.BucketQuota, true
}
...
// SetBucketQuota gets a reference to the given float32 and assigns it to the BucketQuota field.
...
func (o CreateOrganizationQuota) ToMap() (map[string]any, error) {
	...
	if !IsNil(o.BucketQuota) {
		toSerialize["bucketQuota"] = o.BucketQuota
	}
