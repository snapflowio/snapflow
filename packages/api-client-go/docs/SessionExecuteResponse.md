...
------------ | ------------- | ------------- | -------------
**CmdId** | Pointer to **string** | The ID of the executed command | [optional] 
**Output** | Pointer to **string** | The output of the executed command | [optional] 
**ExitCode** | Pointer to **float32** | The exit code of the executed command | [optional] 
