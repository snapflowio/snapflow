...
type Sandbox struct {
	...
	ExecutorDomain *string `json:"executorDomain,omitempty"`
	// Array of buckets attached to the sandbox
	Buckets []SandboxBucket `json:"buckets,omitempty"`
...
// GetExecutorDomain returns the ExecutorDomain field value if set, zero value otherwise.
func (o *Sandbox) GetExecutorDomain() string {
	if o == nil || IsNil(o.ExecutorDomain) {
		var ret string
		return ret
	}
...
// GetExecutorDomainOk returns a tuple with the ExecutorDomain field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetExecutorDomain gets a reference to the given string and assigns it to the ExecutorDomain field.
...
// SetBuckets gets a reference to the given []SandboxBucket and assigns it to the Buckets field.
...
func (o Sandbox) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NodeVersion) {
		toSerialize["nodeVersion"] = o.NodeVersion
	}
