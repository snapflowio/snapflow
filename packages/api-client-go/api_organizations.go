...
type OrganizationsAPI interface {
	...
	*/
	CancelOrganizationInvitation(ctx context.Context, invitationId string, organizationId string) OrganizationsAPICancelOrganizationInvitationRequest
	...
	/*
		CreateCheckoutLink Get payment checkout link

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param organizationId
		@return OrganizationsAPICreateCheckoutLinkRequest
	*/
	CreateCheckoutLink(ctx context.Context, organizationId string) OrganizationsAPICreateCheckoutLinkRequest

	// CreateCheckoutLinkExecute executes the request
	CreateCheckoutLinkExecute(r OrganizationsAPICreateCheckoutLinkRequest) (*http.Response, error)
	...
	*/
	UpdateOrganizationInvitation(ctx context.Context, invitationId string, organizationId string) OrganizationsAPIUpdateOrganizationInvitationRequest
...
CancelOrganizationInvitation Cancel organization invitation
	...
	@return OrganizationsAPICancelOrganizationInvitationRequest
*/
func (a *OrganizationsAPIService) CancelOrganizationInvitation(ctx context.Context, invitationId string, organizationId string) OrganizationsAPICancelOrganizationInvitationRequest {
	return OrganizationsAPICancelOrganizationInvitationRequest{
		ApiService:     a,
		ctx:            ctx,
		invitationId:   invitationId,
...
type OrganizationsAPICreateCheckoutLinkRequest struct {
	ctx                        context.Context
	ApiService                 OrganizationsAPI
	organizationId             string
...
func (r OrganizationsAPICreateCheckoutLinkRequest) CreateOrganizationCheckout(createOrganizationCheckout CreateOrganizationCheckout) OrganizationsAPICreateCheckoutLinkRequest {
	r.createOrganizationCheckout = &createOrganizationCheckout
	return r
}

func (r OrganizationsAPICreateCheckoutLinkRequest) Execute() (*http.Response, error) {
	return r.ApiService.CreateCheckoutLinkExecute(r)
}
...
CreateCheckoutLink Get payment checkout link
	...
	@return OrganizationsAPICreateCheckoutLinkRequest
*/
func (a *OrganizationsAPIService) CreateCheckoutLink(ctx context.Context, organizationId string) OrganizationsAPICreateCheckoutLinkRequest {
	return OrganizationsAPICreateCheckoutLinkRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
// Execute executes the request
func (a *OrganizationsAPIService) CreateCheckoutLinkExecute(r OrganizationsAPICreateCheckoutLinkRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsAPIService.CreateCheckoutLink")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organizations/{organizationId}/billing/checkout"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createOrganizationCheckout == nil {
		return nil, reportError("createOrganizationCheckout is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createOrganizationCheckout
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
UpdateOrganizationInvitation Update organization invitation
	...
	@return OrganizationsAPIUpdateOrganizationInvitationRequest
*/
func (a *OrganizationsAPIService) UpdateOrganizationInvitation(ctx context.Context, invitationId string, organizationId string) OrganizationsAPIUpdateOrganizationInvitationRequest {
	return OrganizationsAPIUpdateOrganizationInvitationRequest{
		ApiService:     a,
		ctx:            ctx,
		invitationId:   invitationId,
