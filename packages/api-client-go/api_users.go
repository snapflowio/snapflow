...
type UsersAPI interface {
	...
	*/
	...
	//  @return User
	CreateUserExecute(r UsersAPICreateUserRequest) (*User, *http.Response, error)
	...
	*/
	...
	//  @return []User
	ListUsersExecute(r UsersAPIListUsersRequest) ([]User, *http.Response, error)
}
...
func (r UsersAPICreateUserRequest) Execute() (*User, *http.Response, error) {
...
//  @return User
func (a *UsersAPIService) CreateUserExecute(r UsersAPICreateUserRequest) (*User, *http.Response, error) {
	var (
...
func (r UsersAPIListUsersRequest) Execute() ([]User, *http.Response, error) {
...
// Execute executes the request
//  @return []User
func (a *UsersAPIService) ListUsersExecute(r UsersAPIListUsersRequest) ([]User, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
