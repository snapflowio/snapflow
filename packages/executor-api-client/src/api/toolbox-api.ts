 ...
 * @export
 */
export const ToolboxApiAxiosParamCreator = function (
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.sandboxesSandboxIdToolboxPathDelete(
          sandboxId,
          path,
          options,
        );
      ...
      const localVarOperationServerBasePath =
        operationServerMap["ToolboxApi.sandboxesSandboxIdToolboxPathDelete"]?.[
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.sandboxesSandboxIdToolboxPathGet(
          sandboxId,
          path,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ToolboxApi.sandboxesSandboxIdToolboxPathGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.sandboxesSandboxIdToolboxPathPost(
          sandboxId,
          path,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ToolboxApi.sandboxesSandboxIdToolboxPathPost"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export class ToolboxApi extends BaseAPI {
   ...
   * @memberof ToolboxApi
   */
  public sandboxesSandboxIdToolboxPathDelete(
    sandboxId: string,
    path: string,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof ToolboxApi
   */
  public sandboxesSandboxIdToolboxPathGet(
    sandboxId: string,
    path: string,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof ToolboxApi
   */
  public sandboxesSandboxIdToolboxPathPost(
    sandboxId: string,
    path: string,
    options?: RawAxiosRequestConfig,
  ) {
