...
const ToolboxApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        sandboxesSandboxIdToolboxPathDelete: async (sandboxId, path, options = {}) => {
            // verify required parameter 'sandboxId' is not null or undefined
            (0, common_1.assertParamExists)("sandboxesSandboxIdToolboxPathDelete", "sandboxId", sandboxId);
            // verify required parameter 'path' is not null or undefined
            (0, common_1.assertParamExists)("sandboxesSandboxIdToolboxPathDelete", "path", path);
         ...
         * @throws {RequiredError}
         */
        sandboxesSandboxIdToolboxPathPost: async (sandboxId, path, options = {}) => {
            // verify required parameter 'sandboxId' is not null or undefined
            (0, common_1.assertParamExists)("sandboxesSandboxIdToolboxPathPost", "sandboxId", sandboxId);
            // verify required parameter 'path' is not null or undefined
            (0, common_1.assertParamExists)("sandboxesSandboxIdToolboxPathPost", "path", path);
            const localVarPath = `/sandboxes/{sandboxId}/toolbox/{path}`
                .replace(`{${"sandboxId"}}`, encodeURIComponent(String(sandboxId)))
                .replace(`{${"path"}}`, encodeURIComponent(String(path)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
const ToolboxApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async sandboxesSandboxIdToolboxPathDelete(sandboxId, path, options) {
            ...
            const localVarOperationServerBasePath = base_1.operationServerMap["ToolboxApi.sandboxesSandboxIdToolboxPathDelete"]?.[localVarOperationServerIndex]?.url;
        ...
        async sandboxesSandboxIdToolboxPathGet(sandboxId, path, options) {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap["ToolboxApi.sandboxesSandboxIdToolboxPathGet"]?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Forwards the request to the specified sandbox\'s container
         ...
         * @throws {RequiredError}
         */
        async sandboxesSandboxIdToolboxPathPost(sandboxId, path, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.sandboxesSandboxIdToolboxPathPost(sandboxId, path, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = base_1.operationServerMap["ToolboxApi.sandboxesSandboxIdToolboxPathPost"]?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
