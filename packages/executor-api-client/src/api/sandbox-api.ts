...
export const SandboxApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async start(sandboxId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
...
export class SandboxApi extends BaseAPI {
    ...
    public start(sandboxId: string, options?: RawAxiosRequestConfig) {
        return SandboxApiFp(this.configuration).start(sandboxId, options).then((request) => request(this.axios, this.basePath));
    }
