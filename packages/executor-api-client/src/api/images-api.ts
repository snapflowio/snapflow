...
export const ImagesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getBuildLogs: async (imageRef: string, follow?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ImagesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async buildImage(request: BuildImageRequestDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.buildImage(request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ImagesApi.buildImage']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async getBuildLogs(imageRef: string, follow?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBuildLogs(imageRef, follow, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ImagesApi.getBuildLogs']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Check if a specified image exists locally
         ...
         * @throws {RequiredError}
         */
        async imageExists(image: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImageExistsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.imageExists(image, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ImagesApi.imageExists']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Pull a image from a registry
         ...
         * @throws {RequiredError}
         */
        async pullImage(request: PullImageRequestDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.pullImage(request, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ImagesApi.pullImage']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Remove a specified image from the local system
         ...
         * @throws {RequiredError}
         */
        async removeImage(image: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
...
export class ImagesApi extends BaseAPI {
    ...
    public buildImage(request: BuildImageRequestDTO, options?: RawAxiosRequestConfig) {
        return ImagesApiFp(this.configuration).buildImage(request, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getBuildLogs(imageRef: string, follow?: boolean, options?: RawAxiosRequestConfig) {
        return ImagesApiFp(this.configuration).getBuildLogs(imageRef, follow, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public imageExists(image: string, options?: RawAxiosRequestConfig) {
        return ImagesApiFp(this.configuration).imageExists(image, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public pullImage(request: PullImageRequestDTO, options?: RawAxiosRequestConfig) {
        return ImagesApiFp(this.configuration).pullImage(request, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public removeImage(image: string, options?: RawAxiosRequestConfig) {
        return ImagesApiFp(this.configuration).removeImage(image, options).then((request) => request(this.axios, this.basePath));
    }
}
