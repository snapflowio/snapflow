				...
				<ModalContent size="md" showClose={false}>
					...
					<ModalBody>
						<p className="text-[13px] text-text-secondary">
							Sorry, we couldn&apos;t load the page. This might be a temporary
							issue. Please try again, and if the problem continues, reach out
							to support.
						</p>
						<div className="mt-3 rounded-lg border border-border bg-surface-1">
							<div className="flex items-center justify-between border-border border-b px-3 py-1.5">
								<span className="font-mono text-[11px] text-text-icon">
									Error details
								</span>
								<button
									type="button"
