  ...
  useEffect(() => {
    ...
    apiClient.oauthApi
      ...
      .catch((err) => {
        ...
        const message = err instanceof Error ? err.message : "Failed to authorize access";
        setError(message);
      });
  ...
  return (
    <AuthLayout>
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="font-season text-[15px] text-text-icon">Authorizing sandbox access...</p>
      </div>
    </AuthLayout>
  );
}
