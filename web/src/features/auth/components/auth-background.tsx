...
function AuthBackgroundSVG() {
  return (
    <>
      ...
      >
        <svg viewBox="0 0 344 328" fill="none" className="h-full w-full">
          <path
      ...
      >
        <svg viewBox="0 0 471 470" fill="none" className="h-full w-full">
          <path
...
export function AuthBackground({ className, children }: AuthBackgroundProps) {
  return (
    <div className={cn("fixed inset-0 overflow-hidden", className)}>
      <div className="pointer-events-none absolute inset-0 -z-50 bg-bg" />
      <AuthBackgroundSVG />
