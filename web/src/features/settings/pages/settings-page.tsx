...
import { DeleteOrganizationModal } from "@/components/modals/delete-organization-modal";
...
export default function SettingsPage() {
  ...
  }, [selectedOrganization, organizationsApi, refreshOrganizations, navigate]);
  ...
  const showDangerZone = !selectedOrganization.personal && authenticatedUserOrganizationMember;
        ...
        <div className="mx-auto max-w-2xl space-y-6">
          ...
          <div className="rounded-lg border border-border">
            <div className="border-border border-b px-5 py-3">
              <h2 className="font-medium text-[14px] text-text-body">General</h2>
            ...
            <div className="flex flex-col gap-4 p-5">
              <div className="flex flex-col gap-1">
                <label className="font-medium text-[13px] text-text-primary">Organization ID</label>
                <div className="flex items-center rounded-[5px] border border-border-1 bg-surface-2">
                  ...
                  <button
                    ...
                    onClick={() => handleCopyToClipboard(selectedOrganization?.id ?? "")}
                  >
              ...
              <div className="flex flex-col gap-1">
                <label className="font-medium text-[13px] text-text-primary">
                  Organization Name
                </label>
                <input
          ...
          {showDangerZone && (
            <div className="rounded-lg border border-red-500/30">
              <div className="border-red-500/30 border-b px-5 py-3">
                <h2 className="font-medium text-[14px] text-red-400">Danger Zone</h2>
                <p className="mt-0.5 text-[12px] text-text-muted">
                ...
                {isOwner ? (
                  <div className="flex items-start justify-between gap-6">
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-[11px] text-text-muted">
                        ...
                        sandboxes, images, registries, and API keys. This action cannot be undone.
                      </p>
                    </div>
                  ...
                  <div className="flex items-start justify-between gap-6">
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-[11px] text-text-muted">
                        You will lose access to all resources in this organization. You can be
                        re-invited by an owner at any time.
                      </p>
                    </div>
