      ...
      <ModalContent size="sm">
        ...
        <ModalBody>
          <p className="text-[13px] text-text-secondary">
            Are you sure you want to cancel this invitation to join the organization? This action
            cannot be undone.
          </p>
        </ModalBody>
        <ModalFooter>
          ...
          <Button variant="destructive" onClick={handleCancelInvitation} disabled={loading}>
