...
>(({ className, ...props }, ref) => (
	<th
		ref={ref}
		className={cn(
			'h-10 px-3 py-2 text-left align-middle font-medium text-text-secondary [&:has([role=checkbox])]:pr-0 *:[[role=checkbox]]:translate-y-0.5',
			className
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<caption
		ref={ref}
		className={cn('mt-4 text-text-muted text-sm', className)}
		{...props}
	/>
));
