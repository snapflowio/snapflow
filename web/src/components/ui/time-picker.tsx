			...
			<Popover open={open} onOpenChange={setOpen}>
				<div ref={ref} className="relative w-full" {...props}>
					...
					<PopoverContent
						...
						align="start"
						sideOffset={4}
						className="w-auto rounded-md border border-border-1 p-2"
					>
						<div className="flex items-center gap-1.5">
							<input
								ref={hourInputRef}
								className="w-10 rounded-sm border border-border-1 bg-surface-5 px-1.5 py-1.25 text-center font-medium font-sans text-text-primary text-[13px] outline-none transition-colors placeholder:text-text-muted focus:outline-none focus-visible:outline-none focus-visible:ring-0"
								value={hour}
								...
								autoComplete="off"
							/>
							<span className="font-medium text-text-muted text-[13px]">:</span>
							<input
								className="w-10 rounded-sm border border-border-1 bg-surface-5 px-1.5 py-1.25 text-center font-medium font-sans text-text-primary text-[13px] outline-none transition-colors placeholder:text-text-muted focus:outline-none focus-visible:outline-none focus-visible:ring-0"
								value={minute}
								...
								autoComplete="off"
							/>
							<div className="ml-0.5 flex overflow-hidden rounded-sm border border-border-1">
								{(['AM', 'PM'] as const).map((period) => (
									<button
										...
										className={cn(
											'px-2 py-1.25 font-medium font-sans text-[12px] transition-colors',
											ampm === period
												? 'bg-brand-secondary text-bg'
												: 'bg-surface-5 text-text-secondary hover:bg-surface-7 hover:text-text-primary dark:hover:bg-surface-5'
										)}
									>
										{period}
									</button>
