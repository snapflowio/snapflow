      ...
      <Popover open={open} onOpenChange={setOpen}>
        <div ref={ref} className="relative w-full" {...props}>
          ...
          <PopoverContent
            ...
            align="start"
            sideOffset={4}
            className="w-auto rounded-[6px] border border-(--border-1) p-[8px]"
          >
            <div className="flex items-center gap-[6px]">
              <input
                ref={hourInputRef}
                className="w-[40px] rounded-[4px] border border-(--border-1) bg-(--surface-5) px-[6px] py-[5px] text-center font-medium font-sans text-(--text-primary) text-[13px] outline-none transition-colors placeholder:text-(--text-muted) focus:outline-none focus-visible:outline-none focus-visible:ring-0"
                value={hour}
              ...
              <input
                ...
                autoComplete="off"
              />
              <div className="ml-[2px] flex overflow-hidden rounded-[4px] border border-(--border-1)">
