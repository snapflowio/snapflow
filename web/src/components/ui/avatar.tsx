 ...
 */
const avatarStatusVariants = cva("absolute bottom-0 right-0 rounded-full border-2 border-(--bg)", {
  variants: {
    status: {
      online: "bg-[#16a34a]",
...
>(({ className, ...props }, ref) => (
  <AvatarPrimitive.Fallback
    ref={ref}
    className={cn(
      "flex h-full w-full items-center justify-center rounded-full border border-border-1 bg-surface-4 font-medium text-text-secondary text-xs",
      className
    )}
    {...props}
  />
