...
const STYLES = {
  ...
  colorScheme: {
    ...
    inverted: {
      ...
      content: "bg-[#1b1b1b] text-white dark:bg-(--surface-3) dark:text-foreground",
  ...
  states: {
    default: {
      active: "bg-(--border-1) text-(--text-primary) [&_svg]:text-(--text-primary)",
      hover:
    ...
    secondary: {
      ...
      hover: "hover:bg-(--brand-secondary) hover:text-white hover:[&_svg]:text-white",
    },
    inverted: {
      active:
    ...
    const content = (
      <PopoverPrimitive.Content
        ...
        className={cn(
          ...
          STYLES.content,
          hasUserWidthConstraint && "**:data-popover-section:truncate [&_.flex-1]:truncate",
