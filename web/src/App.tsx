	...
	return (
		<Routes>
			...
			>
				...
				<Route
					path={getRouteSubPath(Path.SETTINGS)}
					element={<SettingsPage />}
				/>
				<Route path={getRouteSubPath(Path.ACCOUNT)} element={<AccountPage />} />
			</Route>
