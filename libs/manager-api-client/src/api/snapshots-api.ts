  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["SnapshotsApi.buildSnapshot"]?.[
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["SnapshotsApi.getBuildLogs"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async pullSnapshot(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.pullSnapshot(
        request,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["SnapshotsApi.pullSnapshot"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async removeSnapshot(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.removeSnapshot(
        snapshot,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["SnapshotsApi.removeSnapshot"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async snapshotExists(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<SnapshotExistsResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.snapshotExists(
        snapshot,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["SnapshotsApi.snapshotExists"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
