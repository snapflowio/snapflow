	...
	return (
		<Link
			...
			className={cn(
				...
				// Desktop styles (lg+)
				'lg:mb-px lg:block lg:rounded-md lg:px-2.5 lg:py-1.5 lg:font-normal lg:text-[13px] lg:leading-tight',
...
export function SidebarFolder({
	...
	return (
		<div className="flex flex-col lg:mb-px">
			<div className="flex w-full items-center lg:gap-0.5">
				{item.index ? (
					...
					>
						...
						<ChevronRight
							className={cn(
								'ml-auto hidden h-3 w-3 shrink-0 text-gray-400 transition-transform duration-200 ease-in-out lg:block dark:text-gray-500',
								open && 'rotate-90'
							)}
						/>
					</button>
			...
			{hasChildren && (
				...
				>
					<div className="overflow-hidden">
						...
						<div className="ml-4 flex flex-col gap-0.5 lg:hidden">
							{children}
						</div>
						{/* Desktop: styled with border */}
						<ul className="mt-0.5 ml-2 hidden space-y-px border-gray-200/60 border-l pl-2.5 lg:block dark:border-gray-700/60">
							{children}
						</ul>
					</div>
				</div>
