...
export class Migration1752521979719 implements MigrationInterface {
    name = 'Migration1752521979719'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum" AS ENUM('admin', 'user')`);
        await queryRunner.query(`CREATE TABLE "user" ("id" character varying NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL DEFAULT '', "emailVerified" boolean NOT NULL DEFAULT false, "role" "public"."user_role_enum" NOT NULL DEFAULT 'user', CONSTRAINT "user_id_pk" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."sandbox_state_enum" AS ENUM('creating', 'restoring', 'destroyed', 'destroying', 'started', 'stopped', 'starting', 'stopping', 'error', 'build_failed', 'pending_build', 'building_image', 'unknown', 'pulling_image', 'archiving', 'archived')`);
        ...
        await queryRunner.query(`CREATE TABLE "organization" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "createdBy" character varying NOT NULL, "personal" boolean NOT NULL DEFAULT false, "telemetryEnabled" boolean NOT NULL DEFAULT true, "total_cpu_quota" integer NOT NULL DEFAULT '10', "total_memory_quota" integer NOT NULL DEFAULT '10', "total_disk_quota" integer NOT NULL DEFAULT '30', "max_cpu_per_sandbox" integer NOT NULL DEFAULT '4', "max_memory_per_sandbox" integer NOT NULL DEFAULT '8', "max_disk_per_sandbox" integer NOT NULL DEFAULT '10', "max_image_size" integer NOT NULL DEFAULT '20', "image_quota" integer NOT NULL DEFAULT '100', "bucket_quota" integer NOT NULL DEFAULT '100', "suspended" boolean NOT NULL DEFAULT false, "suspendedAt" TIMESTAMP, "suspensionReason" character varying, "suspendedUntil" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "organization_id_pk" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "organization_role_assignment" ("organizationId" uuid NOT NULL, "userId" character varying NOT NULL, "roleId" uuid NOT NULL, CONSTRAINT "organization_role_assignment_organization_id_user_id_role_id_pk" PRIMARY KEY ("organizationId", "userId", "roleId"))`);
        await queryRunner.query(`CREATE INDEX "organization_role_assignment_organization_id_user_id_index" ON "organization_role_assignment" ("organizationId", "userId") `);
        await queryRunner.query(`CREATE INDEX "organization_role_assignment_role_id_index" ON "organization_role_assignment" ("roleId") `);
        await queryRunner.query(`CREATE TABLE "organization_role_assignment_invitation" ("invitationId" uuid NOT NULL, "roleId" uuid NOT NULL, CONSTRAINT "organization_role_assignment_invitation_invitation_id_role_id_pk" PRIMARY KEY ("invitationId", "roleId"))`);
        await queryRunner.query(`CREATE INDEX "organization_role_assignment_invitation_invitation_id_index" ON "organization_role_assignment_invitation" ("invitationId") `);
        await queryRunner.query(`CREATE INDEX "organization_role_assignment_invitation_role_id_index" ON "organization_role_assignment_invitation" ("roleId") `);
        await queryRunner.query(`ALTER TABLE "sandbox" ADD CONSTRAINT "sandbox_build_info_image_ref_fk" FOREIGN KEY ("buildInfoImageRef") REFERENCES "build_info"("imageRef") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "image" ADD CONSTRAINT "image_build_info_image_ref_fk" FOREIGN KEY ("buildInfoImageRef") REFERENCES "build_info"("imageRef") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_user" ADD CONSTRAINT "organization_user_organization_id_fk" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_role" ADD CONSTRAINT "organization_role_organization_id_fk" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_invitation" ADD CONSTRAINT "organization_invitation_organization_id_fk" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_role_assignment" ADD CONSTRAINT "organization_role_assignment_organization_id_user_id_fk" FOREIGN KEY ("organizationId", "userId") REFERENCES "organization_user"("organizationId","userId") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "organization_role_assignment" ADD CONSTRAINT "organization_role_assignment_role_id_fk" FOREIGN KEY ("roleId") REFERENCES "organization_role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_role_assignment_invitation" ADD CONSTRAINT "organization_role_assignment_invitation_invitation_id_fk" FOREIGN KEY ("invitationId") REFERENCES "organization_invitation"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "organization_role_assignment_invitation" ADD CONSTRAINT "organization_role_assignment_invitation_role_id_fk" FOREIGN KEY ("roleId") REFERENCES "organization_role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "organization_role_assignment_invitation" DROP CONSTRAINT "organization_role_assignment_invitation_role_id_fk"`);
        await queryRunner.query(`ALTER TABLE "organization_role_assignment_invitation" DROP CONSTRAINT "organization_role_assignment_invitation_invitation_id_fk"`);
        await queryRunner.query(`ALTER TABLE "organization_role_assignment" DROP CONSTRAINT "organization_role_assignment_role_id_fk"`);
        await queryRunner.query(`ALTER TABLE "organization_role_assignment" DROP CONSTRAINT "organization_role_assignment_organization_id_user_id_fk"`);
        await queryRunner.query(`ALTER TABLE "organization_invitation" DROP CONSTRAINT "organization_invitation_organization_id_fk"`);
        await queryRunner.query(`ALTER TABLE "organization_role" DROP CONSTRAINT "organization_role_organization_id_fk"`);
        await queryRunner.query(`ALTER TABLE "organization_user" DROP CONSTRAINT "organization_user_organization_id_fk"`);
        await queryRunner.query(`ALTER TABLE "image" DROP CONSTRAINT "image_build_info_image_ref_fk"`);
        await queryRunner.query(`ALTER TABLE "sandbox" DROP CONSTRAINT "sandbox_build_info_image_ref_fk"`);
        await queryRunner.query(`DROP INDEX "public"."organization_role_assignment_invitation_role_id_index"`);
        await queryRunner.query(`DROP INDEX "public"."organization_role_assignment_invitation_invitation_id_index"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."organization_role_assignment_organization_id_user_id_index"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."registry_registrytype_enum"`);
        await queryRunner.query(`DROP TABLE "bucket"`);
        await queryRunner.query(`DROP TYPE "public"."bucket_state_enum"`);
        await queryRunner.query(`DROP TABLE "executor"`);
        await queryRunner.query(`DROP TYPE "public"."executor_state_enum"`);
        await queryRunner.query(`DROP TYPE "public"."executor_region_enum"`);
        await queryRunner.query(`DROP TYPE "public"."executor_class_enum"`);
