...
export class AuthModule implements NestModule, OnModuleInit {
  ...
  private static createExceptionFilterProvider(): Provider {
    return {
      provide: APP_FILTER,
      useFactory: (options: AuthModuleOptions, httpAdapterHost: HttpAdapterHost) => {
        return options.disableExceptionFilter ? null : new AllExceptionsFilter(httpAdapterHost);
      },
      inject: [AUTH_MODULE_OPTIONS_KEY, HttpAdapterHost],
    };
  }
}
