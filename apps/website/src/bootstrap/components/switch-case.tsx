...
type SwitchProps<T> = Readonly<{
  ...
  children:
    | (ReactElement<CaseProps<T>> | ReactElement<DefaultProps>)[]
    | (ReactElement<CaseProps<T>> | ReactElement<DefaultProps>);
}>;
 ...
 * </Switch.Case>
 */
Switch.Case = <T,>({ children }: CaseProps<T>): ReactNode => children;
 ...
 * </Switch.Default>
 */
Switch.Default = ({ children }: DefaultProps): ReactNode => children;
