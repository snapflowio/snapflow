...
const statuses: FacetedFilterOption[] = [
  { label: getStateLabel(BucketState.CREATING), value: BucketState.CREATING, icon: Timer },
  { label: getStateLabel(BucketState.READY), value: BucketState.READY, icon: CheckCircle },
  {
    label: getStateLabel(BucketState.PENDING_CREATE),
    value: BucketState.PENDING_CREATE,
    icon: Timer,
  },
  {
    label: getStateLabel(BucketState.PENDING_DELETE),
    value: BucketState.PENDING_DELETE,
    icon: Timer,
  },
  { label: getStateLabel(BucketState.DELETING), value: BucketState.DELETING, icon: Timer },
  { label: getStateLabel(BucketState.DELETED), value: BucketState.DELETED, icon: Timer },
  { label: getStateLabel(BucketState.ERROR), value: BucketState.ERROR, icon: AlertTriangle },
];
