    ...
    <>
      ...
      <Drawer.Root open={open} onClose={closeDrawer}>
        ...
        >
          ...
          <p className="ml-2.5 font-medium text-sm">Categories</p>
        </Drawer.Trigger>
        <Drawer.Overlay
  ...
  return (
    <Link href={href} onClick={clickAction}>
      {mobile ? (
        ...
        <li
          className={cn(
            "-mb-px border-transparent border-b-2 font-medium text-muted-foreground hover:text-foreground",
            {
              "border-white text-foreground": active,
            }
          )}
        >
