...
import { AlertTriangle, Box, CheckCircle, Loader2Icon, MoreHorizontal, Pause } from "lucide-react";
                ...
                <TableEmptyState
                  ...
                  description={
                    <p>
                      ...
                      Docker-compatible image. Use them to define language runtimes, dependencies,
                      and tools for your sandboxes.
                    </p>
                  }
                />
              )}
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex flex-row items-center gap-2 text-background text-xs">
            ...
            <div className="rounded-sm bg-[#FE9C67] p-1 px-2">{image.cpu} vCPU</div>
          </div>
        );
      },
    },
