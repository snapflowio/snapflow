    ...
    <div className="m-0 flex overflow-hidden bg-background p-0">
      ...
      >
        <use href="#cube" x="26" y="218" strokeWidth="2" opacity="0.3">
          <animate attributeName="stroke" dur="6s" repeatCount="indefinite" values="#a8ed6b;" />
        </use>
        ...
        <defs>
          ...
          <linearGradient id="fade" gradientTransform="rotate(90)">
            <stop offset="0" stopColor="#0E0E1000" />
            <stop offset="0.25" stopColor="#0E0E10FF" />
          </linearGradient>
          ...
          >
            ...
            <use href="#star01" x="64" y="96" fill="#a8ed6b" transform="rotate(90 80 112)" />
            <use href="#star01" x="224" y="102" fill="#a8ed6b" />
            <use href="#star01" x="192" y="112" fill="#ffffff" transform="rotate(90 80 112)" />
            <use href="#star02" x="16" y="64" fill="#a8ed6b" />
            <use href="#star03" x="96" y="16" fill="#ffffff" />
            <use href="#star04" x="64" y="64" fill="#a8ed6b" />
            <use href="#star04" x="8" y="16" fill="#a8ed6b" />
            <use href="#star04" x="110" y="96" fill="#ffffff" />
            <use href="#star02" x="160" y="24" fill="#a8ed6b" />
            <use href="#star03" x="196" y="60" fill="#ffffff" />
            <use href="#star04" x="64" y="212" fill="#a8ed6b" />
            <use href="#star04" x="218" y="216" fill="#a8ed6b" />
            <use href="#star03" x="228" y="220" fill="#ffffff" />
            <use href="#star02" x="140" y="128" fill="#a8ed6b" />
            <use href="#star03" x="24" y="140" fill="#ffffff" />
            <use href="#star04" x="95" y="160" fill="#a8ed6b" />
            <use href="#star04" x="180" y="128" fill="#a8ed6b" />
            <use href="#star03" x="200" y="136" fill="#ffffff" />
            <use href="#star10" x="120" y="120" stroke="#ffffff" />
            <use href="#star11" x="48" y="64" stroke="#a8ed6b" />
          </pattern>
