...
export type Changelog = {
  ...
  tags?: ('Feature' | 'Bug Fix' | 'Enhancement' | 'Breaking Change' | 'Security' | 'Performance')[] | undefined
  published: boolean
  /** MDX file body */
  body: MDX
  slug: string
...
export type DocumentTypes = Changelog | Doc | Guide | Page | Post
export type DocumentTypeNames = 'Changelog' | 'Doc' | 'Guide' | 'Page' | 'Post'
